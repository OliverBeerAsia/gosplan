...
export interface GameStateData {
  ...
  rngSeed: number; // persisted for deterministic simulation replay
  rngState: number; // mutable RNG cursor persisted in saves
  mapSeed: number; // deterministic terrain seed for campaign/sandbox starts
